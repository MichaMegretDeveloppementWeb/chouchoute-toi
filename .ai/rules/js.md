...
Cette passe (`reglerLesChevauchements`) tourne sur mutation du placement et se garde de se répondre à elle-même. Une mesure qui échoue parce que la carte est encore masquée doit donc **redemander un essai** : rien ne remuera plus une fois la mise en page finie.

...
<a href="{{ $href }}" class="flex items-center fb-sidebar-gap gap-x-3 px-5 py-3 hover:bg-gray-50 lg:px-0 lg:py-3 transition-[gap,background-color] duration-300 ease-in-out dark:hover:bg-gray-800">
